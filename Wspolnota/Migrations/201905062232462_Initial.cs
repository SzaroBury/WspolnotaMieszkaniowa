namespace Wspolnota.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.AspNetUsers", "Community_CommunityID", "dbo.Communities");
            DropForeignKey("dbo.Announcements", "Community_CommunityID", "dbo.Communities");
            ...
            DropIndex("dbo.AspNetUsers", new[] { "Community_CommunityID" });
            DropIndex("dbo.AspNetUsers", "UserNameIndex");
            DropIndex("dbo.Announcements", new[] { "Author_Id" });
            DropIndex("dbo.Announcements", new[] { "Community_CommunityID" });
